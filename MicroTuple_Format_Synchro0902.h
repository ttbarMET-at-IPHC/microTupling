...
//                       #            Keep me updated !             #
//                       ############################################
#define MICROEVENT_FORMATROOT "event:triggerMu:triggerEl:leptonPt:leptonEta:leptonPhi:leptonE:leptonPFPt:leptonIso:leptonEpin:leptonPDG:nJets:nB:jets_Pt[10]:jets_Phi[10]:jets_Eta[10]:jets_Sigma[10]:leadingBPt:MET:isoTrackVeto:tauVeto:MT:dPhiMETjet:hadronicChi2:MT2W:HTratio:dRleptonB"
  ...
  // ######################
    ...
    for (int i = 0 ; i < 10 ; i++)
    {
        ...
        else
        {
            ...
            myEvent.jets_Sigma[i] = Resolution::GetSigmaJet(jets[i].p4) * Resolution::GetSigmaScaleFactor(jets[i].p4.Eta());
        }
    }
