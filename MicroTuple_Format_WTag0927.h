...
//                       #            Keep me updated !             #
//                       ############################################
#define MICROEVENT_FORMATROOT "trueNumberOfEvents:nJets:nBtags:jet_pT[10]:jet_eta[10]:jet_phi[10]:jet_bTag[10]:lep_pT:lep_eta:lep_phi:lep_flavor:MET:MT:HadronicChi2:MT2W:DPhi_MetJets:isolatedTrackVeto:tauVeto:mStop:mNeutralino:genW_pT:genW_Eta:genW_Phi:q1_pT:q1_Eta:q1_Phi:q2_pT:q2_Eta:q2_Phi:recoW_pT[10]:recoW_Eta[10]:recoW_Phi[10]:recoW_Mass[10]:recoW_Tau1[10]:recoW_Tau2[10]:recoW_Tau3[10]"
  ...
  // ######################
    ...
    // Find hadronic W (assume there's only one)
        ...
        if (genW_Index != -1)
        {
            ...
            myEvent.q1_pT    = MCParticles[quark1FromGenW_Index].p4.Pt();
            myEvent.q1_Eta   = MCParticles[quark1FromGenW_Index].p4.Eta();
            myEvent.q1_Phi   = MCParticles[quark1FromGenW_Index].p4.Phi();
            myEvent.q2_pT    = MCParticles[quark2FromGenW_Index].p4.Pt();
            myEvent.q2_Eta   = MCParticles[quark2FromGenW_Index].p4.Eta();
            myEvent.q2_Phi   = MCParticles[quark2FromGenW_Index].p4.Phi();
        }
        else
        {
            myEvent.genW_pT  = -1;
